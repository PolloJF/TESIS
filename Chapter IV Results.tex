...
\newp  
A continuación se muestran los resultados de correlación IQ y correlación simple para distintas estructuras de preámbulo considerando un largo total de 12 segundos.

%\begin{figure}[H]
%    \centering
%    \begin{subfigure}[b]{0.49\textwidth}
%        \centering
%        \includegraphics[width=\textwidth]{img/Correlacion_IQ_4simbolos.png}
%        \caption{4-symbol preamble}
%        \label{fig:sub1-preamble-corr}
%    \end{subfigure}
%    \hfill
%    \begin{subfigure}[b]{0.49\textwidth}
%        \centering
%        \includegraphics[width=\textwidth]{img/Correlacion_IQ_8simbolos.png}
%        \caption{8-symbol preamble}
%        \label{fig:sub2-preamble-corr}
%    \end{subfigure}
%    \vfill
%    \begin{subfigure}[b]{0.49\textwidth}
%        \centering
%        \includegraphics[width=\textwidth]{img/Correlacion_IQ_16simbolos.png}
%        \caption{16-symbol preamble}
%        \label{fig:sub3-preamble-corr}
%    \end{subfigure}
%    \hfill
%    \begin{subfigure}[b]{0.49\textwidth}
%        \centering
%        \includegraphics[width=\textwidth]{img/Correlacion_IQ_32simbolos.png}
%        \caption{32-symbol preamble}
%        \label{fig:sub4-preamble-corr}
%    \end{subfigure}
%    \caption{IQ Correlation for different preamble structures with 12 seconds length.}
...
\newp
De esta manera se logra reducir la tasa de sampleo del sistema original de 48 kHz a una tasa final de 1000 Hz, lo que representa una reducción significativa en la cantidad de datos a procesar. A continuación se muestran los resultados obtenidos al aplicar el proceso de decimación en términos de la tasa de error de símbolos (SER).


%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.7\textwidth]{img/SER_vs_SNR_decimation.png}
%    \caption{SER vs SNR for 8-FSK and 16-FSK with decimation.}
%    \label{fig:SER-vs-SNR-decimation}
%\end{figure}

Si bien el proceso de decimación logra reducir la cantidad de datos a procesar, se observa luego de la realización de múltiples pruebas en terreno que la variabilidad del "peak" de correlación se incrementa al aplicar este proceso, lo que dificulta la detección precisa del inicio del mensaje transmitido. %% A qué podría deberse
\newp
A continuación se muestra una simulación de la variabilidad del peak de correlación al aplicar el proceso de decimación en comparación con el sistema sin decimación.
